...
// Plan of Attack  
// ---> Update the Car Class to pass model attribute upon initialization
// class Car{
//   constructor(){
...
// Plan of Attack
// ---> Update the Car Class to pass year attribute upon initialization
// class Car{
//   constructor(){
//     this.model = "generic car"
...
// ---> Plan of Attack
// Update the Car class with a light attribute
// constructor(){
//   this.model = "generic car"
//   this.year = "myCar year"
//   this.lights = "off"
...
// ---> Plan of Attack
// Update the Car class with a signal attribute
//   this.signal = "off"


// Story: As a programmer, I can determine the speed of a car. Speed starts at 0 mph.
// Update the Car class with a speed attribute
//   this.speed = 0
...
// update Car Class constructor to accept two parameters of model and year. Ensure model and year properties reflect these parameters
// constructor(model, year){
//   this.model = model
//   this.year = year
//   this.lights = "off"
...
// update constructor and super of the Telsa, Toyota, and Volkswagen objects to inherit model and year
// constructor(model, year){
//   super(model, year)
// }
...
// Reassign the Telsa, Toyota, and Volkswagen objects to give unique arguments to the model and year properties. 
// let myTesla = new Tesla("Tesla", 2021)
// let myToyota = new Toyota("Toyota", 1993)
// let myVolkswagen = new Volkswagen("Volkswagen", 1989)
